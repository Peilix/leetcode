...
TEST(Asteroid_Collision, Example_1)
{
    std::vector<int> asteroids({ 5, 10, -5 });
    Solution::asteroidCollision(asteroids);
    EXPECT_EQ(std::vector<int>({ 5, 10 }), Solution::asteroidCollision(asteroids));
}

TEST(Asteroid_Collision, Example_2)
{
    std::vector<int> asteroids({ 8, -8 });
    Solution::asteroidCollision(asteroids);
    EXPECT_EQ(std::vector<int>(), Solution::asteroidCollision(asteroids));
}

TEST(Asteroid_Collision, Example_3)
{
    std::vector<int> asteroids({ 10, 2, -5 });
    Solution::asteroidCollision(asteroids);
    EXPECT_EQ(std::vector<int>({ 10 }), Solution::asteroidCollision(asteroids));
}

TEST(Asteroid_Collision, Example_4)
{
    std::vector<int> asteroids({ -2, -1, 1, 2 });
    Solution::asteroidCollision(asteroids);
    EXPECT_EQ(asteroids, Solution::asteroidCollision(asteroids));
}
TEST(Asteroid_Collision, Example_5)
{
    std::vector<int> asteroids({ -2, -2, 1, -2 });
    Solution::asteroidCollision(asteroids);
    EXPECT_EQ(std::vector<int>({ -2, -2, -2 }), Solution::asteroidCollision(asteroids));
}
//auto MIN_DEPTH = Solution::minDepth;
//TEST(Minimum_Depth_of_Binary_Tree, MIN_DEPTH)
//{
//    TreeNode test[5];
//    test[0].val = 3;
//    test[1].val = 9;
...
//    test[2].left = &test[3];
//    test[2].right = &test[4];
//    EXPECT_EQ(2, MIN_DEPTH(&test[0]));
//}
TEST(Minimum_Depth_of_Binary_Tree, Example_1)
{
    TreeNode test[5];
    test[0].val = 3;
    test[1].val = 9;
    ...
    test[2].left = &test[3];
    test[2].right = &test[4];
    EXPECT_EQ(2, Solution::minDepth(&test[0]));
}
int main()
{
    ...
    //char * ret = convert(s, 4);
    {
        ...
        std::vector<int> customers { 10, 10, 6, 4, 7 };
        int boardingCost = 3;
        int runningCost = 8;
        ...
        Solution::maximumRequests(n, requests);
    }
    {
        ListNode b(5);
        ListNode a(3, &b);
    ...
    {
        std::vector<int> nums = { 4, 3, 2, 3, 8, 2, 3, 1 };
    ...
    }
    {
        ...
        int k = 2;
        assert(Solution::maxProfit_4th(k, prices) == 7);

        prices = { 1, 2, 4, 2, 5, 7, 2, 4, 9, 0 };
        assert(Solution::maxProfit_4th(k, prices) == 13);
    }
    {
        Codec* ser = new Codec();
        Codec* deser = new Codec();
        std::string tree = "[41,37,44,24,39,42,48,1,35,38,40,null,43,46,49,0,2,30,36,null,null,null,null,null,null,45,47,null,null,null,null,null,4,29,32,null,null,null,null,null,null,3,9,26,null,31,34,null,null,7,11,25,27,null,null,33,null,6,8,10,16,null,null,null,28,null,null,5,null,null,null,null,null,15,19,null,null,null,null,12,null,18,20,null,13,17,null,null,22,null,14,null,null,21,23,null,null,null,null,null,null]";
